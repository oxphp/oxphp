<?php
// Once smoke test — simplified API (no factory closure).
header('Content-Type: text/plain');

$o = new OxPHP\Shared\Once();

if ($o->isInitialized()) { echo "FAIL: initial state\n"; exit; }
if ($o->get() !== null) { echo "FAIL: get empty\n"; exit; }
