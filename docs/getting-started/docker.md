...
FROM ghcr.io/oxphp/oxphp:0.11.0 AS oxphp
...
- **Docker:** `docker run --user www-data ghcr.io/oxphp/oxphp:0.11.0`
- **Compose:**
  ```yaml
  services:
    oxphp:
