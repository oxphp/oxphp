...
| `SCRIPT_FILENAME` | Абсалютны шлях да скрыпту ў файлавай сістэме | `/var/www/html/public/index.php` |
| `DOCUMENT_ROOT` | Каранёвы каталог вэб-сервера | `/var/www/html/public` |
