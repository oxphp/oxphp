...
- **[Три режима маршрутизации](features/routing.md)** — файловый, фреймворк и SPA (любой из них сочетается с постоянным [режимом воркеров](features/worker-mode.md))
...
- [Маршрутизация](features/routing.md) — три режима маршрутизации: традиционное отображение файлов, фронт-контроллер фреймворка и SPA-фолбэк. Режим воркеров — ортогональный переключатель модели выполнения и применяется поверх любого из режимов маршрутизации
