...
## 2. Добавьте compose.yml

Создайте минимальный `compose.yml`:
...
- [Руководство по Docker](/getting-started/docker/) -- этапы Dockerfile, описание compose.yml и монтирование томов
