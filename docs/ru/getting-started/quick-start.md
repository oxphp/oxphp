...
Официальный образ включает серверный бинарный файл, PHP 8.4 или 8.5 ZTS (по умолчанию 8.5; для 8.4 загрузите тег `:0.7.0-php8.4` или любой вариант `*-php8.4*`), PHP-расширение OxPHP и все зависимости времени выполнения.
