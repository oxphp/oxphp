...
Официальный образ включает серверный бинарный файл, PHP 8.4 или 8.5 ZTS (по умолчанию 8.4; для 8.5 загрузите тег `:0.3.0-php8.5` или любой вариант `*-php8.5*`), PHP-расширение OxPHP и все зависимости времени выполнения.
